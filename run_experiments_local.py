...
MODEL_CONFIGS = {
    ...
    # ── Gemma-2 ladder (third family, v2) ──
    "gemma-2b":  {"hf_name": "mlx-community/gemma-2-2b-it-4bit", "type": "local",
                  "params_b": 2.0, "family": "Gemma-2"},
    "gemma-9b":  {"hf_name": "mlx-community/gemma-2-9b-it-4bit", "type": "local",
                  "params_b": 9.0, "family": "Gemma-2"},
